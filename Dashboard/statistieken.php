...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="active"><a href="statistieken.php"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-line-graph"></use></svg> Statistieken</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<?php if ($users_data['users_type'] === 'Manager') {
					include 'statistiekenlist_manager.php';
				}
		?>

		<?php if ($users_data['users_type'] === 'Werknemer') {
					include 'statistiekenlist_werknemer.php';
				}
		?>
