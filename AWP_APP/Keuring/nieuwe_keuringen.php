                       ...
                       <form class="form-horizontal style-form" role="form"  method="POST">
                        ...
                        <br>
                           ...
                           <label class="col-sm-2 col-sm-2 control-label"> <i class="fa fa-phone-square "> </i>  Auto Kenteken </label>
                            ...
                            <div class="form-group">
                           <label class="col-sm-2 col-sm-2 control-label"> <i class="fa fa-user"> </i> Chasisnummer </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="keuring_chasisnummer" >
                              </div>
                          </div>
                          <div class="form-group">
                           <label class="col-sm-2 col-sm-2 control-label"> <i class="fa fa-user"> </i> Auto Model </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="keuring_model" >
                              </div>
                          </div>
                          <div class="form-group">
                           <label class="col-sm-2 col-sm-2 control-label"> <i class="fa fa-clock-o"> </i> Auto Merk </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="keuring_merk">
                              </div>
                          </div>
                        <div class="form-group">
