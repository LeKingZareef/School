           ...
           <form class="form-horizontal style-form" role="form" method="post" >
            <div class="input-group">
              <span class="input-group-btn">
                ...
                <input type="text" class="form-control" placeholder="Bon-nummer" name="bon">
            </div>
           </form>
          </div>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="fact_bew.php" >
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <br>
                              ...
                              <thead>
                              <tr>
                                  <th><i class="fa fa-sort-numeric-desc"></i> Bon-nummer</th>
                                  <th class="hidden-phone"><i class="fa fa-user"></i> Klantnaam</th>
                                  <th><i class="fa fa-phone"></i> Telefoon</th>
                                  <th><i class="fa fa-bookmark"></i> Werknemer</th>
                                  <th></tsh>
                              </tr>
                              </thead>
                              <tbody>
                             ...
                             <?php 
                              include 'assets/includes/zoek_bon.php';
                             ?>
