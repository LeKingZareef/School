<<<<<<< HEAD:Sleepdienst/Autowerkplaats-2016-06-20/Autowerkplaats/nieuw_factuur.php
<!DOCTYPE html>
<html lang="en">
  <head>
                        ...
                        <br>
                          ...
                          <div class="form-group">
                           <label class="col-sm-2 col-sm-2 control-label"> <i class="fa fa-calendar"> </i>   Datum</label>
                              <div class="col-sm-10">
                                  <input type="text" id="disabledInput" disabled="" class="form-control" name="datum" value="<?php
                                   echo "" . date("Y/m/d") 
                                   ?>
                                   ">
                              </div>
...
>>>>>>> parent of 769039e... product wijziging -> product aantal toevoegen:AWP/product_toevoegen.php
