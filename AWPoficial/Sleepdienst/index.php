<?php// require '../Zareef/includes/check.php' ;?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<div class="col-md-4"> 
              ...
              <h1 style="color:#23b8d0; margin-left: 70px;" class="text-center"> <strong>Sleepdienst </strong> </h1>
              </div>
              <div class="col-md-4"> </div>
              <img src="assets/img/sleepdienst.png">
              </div>  
