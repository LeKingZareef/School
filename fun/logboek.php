...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="active"><a href="logboek.php"><svg class="glyph stroked app-window"><use xlink:href="#stroked-app-window"></use></svg> Logboek</a></li>
			<li role="presentation" class="divider"></li>
			<li><a href="logout.php"><svg class="glyph stroked cancel"><use xlink:href="#stroked-cancel"></use></svg> Logout</a></li>
		</ul>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Logboek</h1>
			</div>
		</div><!--/.row-->
			...
			<div class='row'>
				<div class='col-lg-12'>
					<div class='panel panel-default'>
						<div class='panel-heading'>Logboek Aanmaken</div>
						<div class='panel-body'>
							<div class='canvas-wrapper'>
								<a class='btn btn-primary' href='includes/widget/logboekinsert.php'>Nieuw Logboek</a>
							</div>
						</div>
					</div>
				</div>
		...
		<?php if ($users_data['users_type'] === 'Manager') {
					include 'logboekenlist.php';
				}
		?>
		<?php if ($users_data['users_type'] === 'Werknemer') {
					include 'logboekenlist_werknemer.php';
				}
		?>
